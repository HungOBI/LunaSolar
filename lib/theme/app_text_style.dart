...
class AppTextTheme extends ThemeExtension<AppTextTheme> {
  ...
  factory AppTextTheme.fromColorScheme(ColorScheme colorScheme) {
    return AppTextTheme(
      textTheme: TextTheme(
        displayLarge: _style(57, FontWeight.w400, colorScheme.onBackground),
        displayMedium: _style(45, FontWeight.w400, colorScheme.onBackground),
        displaySmall: _style(36, FontWeight.w400, colorScheme.onBackground),
        headlineLarge: _style(32, FontWeight.w400, colorScheme.onBackground),
        headlineMedium: _style(28, FontWeight.w400, colorScheme.onBackground),
        headlineSmall: _style(24, FontWeight.w400, colorScheme.onBackground),
        titleLarge: _style(22, FontWeight.w400, colorScheme.onBackground),
        titleMedium: _style(16, FontWeight.w500, colorScheme.onBackground),
        titleSmall: _style(14, FontWeight.w500, colorScheme.onBackground),
